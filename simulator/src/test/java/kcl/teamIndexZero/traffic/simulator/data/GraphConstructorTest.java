...
public class GraphConstructorTest {
    private RoadDescription rd1, rd2, rd3, rd4, rd5, rd6, rd7, rd8, rd9;
    private JunctionDescription j1, j2, j3, j4;
    private LinkDescription l1, l2;
    ...
    public void setUp() throws Exception {
        ...
        l2 = new LinkDescription(rd8.getId(), rd9.getId(), LinkType.GENERIC, new ID("link2"));
